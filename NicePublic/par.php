...
?>
    ...
    <section id="container" class="">  
        ...
        <aside>
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu">                
                    <li class="active">
                        <a class="" href="<?php echo siteurl();?>/NicePublic/slider.php">
                    ...
                    <li>
                        <a class="" href="<?php echo siteurl();?>/NicePublic/menu.php">
                    ...
                    <li>
                        <a class="" href="<?php echo siteurl();?>/NicePublic/latestpost.php">
                            <i class="fa fa-address-card""></i>
        ...
        <div style="position: fixed; bottom: 0; height: 50px; background: grey; width: 100%">jgdsfjsgdfsdg</div>